...
const TeacherItem:React.FC<TeaherItemProps> = ({ teacher, favorited }) => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    <RectButton style={styles.contactButton} onPress={handleLinkToWahstapp}>
